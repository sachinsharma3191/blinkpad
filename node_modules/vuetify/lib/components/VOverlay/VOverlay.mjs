...
import { makeLazyProps, useLazy } from "../../composables/lazy.mjs"; // Directives

import { ClickOutside } from "../../directives/click-outside/index.mjs"; // Utilities

import { convertToUnit, defineComponent, getScrollParent, standardEasing, useRender } from "../../util/index.mjs";
      ...
      return _createVNode(_Fragment, null, [(_slots$activator = slots.activator) == null ? void 0 : _slots$activator.call(slots, {
        ...
        default: () => [hasContent.value && _createVNode("div", _mergeProps({
          ...
          default: () => [_withDirectives(_createVNode("div", {
            ...
            isActive
          })], 46, ["onKeydown"]), [[_vShow, isActive.value], [_resolveDirective("click-outside"), {
